...
lash10=Lash_set.create(name:"Sunday Funday", price:11)
...
m6 = Makeup_bag.create(user_id:u6.id, lip_gloss_id:lg10.id,  foundation_id:f10.id, lash_set_id:lash11.id )
...
m9 = Makeup_bag.create(user_id:u6.id,  lip_gloss_id:lg12.id, foundation_id:f3.id, lash_set_id:lash5.id)
...
m19 = Makeup_bag.create(user_id:u1.id, lip_gloss_id:lg1.id, foundation_id:f6.id, lash_set_id: lash14.id)
